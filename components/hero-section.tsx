      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl sm:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
            I help businesses grow their online presence through strategic semantic SEO, compelling content marketing, and modern
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-card border border-border rounded-2xl p-6 hover:shadow-lg transition-all duration-300 hover:border-primary/50">
              ...
              <Button asChild className="w-full">
                <Link href="/services/semantic-seo">Learn More</Link>
              </Button>
            </div>
